...
public class Evanescence extends SwordItem {



    public Evanescence(Tier tier, int attackDamageBonus, float attackSpeed, Properties properties) {
    ...
    public boolean onEntitySwing(ItemStack stack, LivingEntity entity) {
        if (entity instanceof Player player && !player.level().isClientSide) {
            if (!ModList.get().isLoaded("bettercombat")) {
            	spawnBookProjectiles(player); // vanilla seulement
            }
        }
        return super.onEntitySwing(stack, entity);
    }

    public void spawnBookProjectiles(Player player) {
