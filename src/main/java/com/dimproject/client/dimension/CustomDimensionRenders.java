...
public final class CustomDimensionRenders {
	...
	public static void registerDimensionEffects(RegisterDimensionSpecialEffectsEvent event) {
		event.register(PlainSky.ID, new PlainSky());
		event.register(PlainSkyNoFog.ID, new PlainSkyNoFog());
		event.register(CelestialOnly.ID, new CelestialOnly());
//		event.register(Shyrelands.ID, new Shyrelands());
//		event.register(Lunalus.ID, new Lunalus());
	}


	public static class PlainSky extends DimensionSpecialEffects  {
		public static final ResourceLocation ID = new ResourceLocation(DimProjectMod.MODID, "plain_sky");
	...
	public static class PlainSkyNoFog extends DimensionSpecialEffects  {
		public static final ResourceLocation ID = new ResourceLocation(DimProjectMod.MODID, "plain_sky_no_fog");

		public PlainSkyNoFog() {
			super(Float.NaN, true, SkyType.NONE, false, true);
		}
	...
	public static class CelestialOnly extends DimensionSpecialEffects {
		public static final ResourceLocation ID = new ResourceLocation(DimProjectMod.MODID, "celestial_only");
